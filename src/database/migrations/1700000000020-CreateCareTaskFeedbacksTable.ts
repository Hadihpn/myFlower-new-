// src/database/migrations/1700000000013-CreateCareTaskFeedbacksTable.ts
import { MigrationInterface, QueryRunner, Table, TableIndex, TableForeignKey } from 'typeorm';

export class CreateCareTaskFeedbacksTable1700000000020 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const taskForeignKey = table.foreignKeys.find(
      (fk) => fk.columnNames.indexOf('care_task_id') !== -1,
    );
    if (taskForeignKey) {
