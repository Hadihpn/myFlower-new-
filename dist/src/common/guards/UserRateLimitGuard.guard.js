...
let UserRateLimitGuard = class UserRateLimitGuard {
    ...
    async canActivate(context) {
        ...
        if (lastRequest) {
            ...
            if (elapsed < 30 * 1000) {
                throw new common_1.HttpException('Too many requests. Wait 30 seconds.', common_1.HttpStatus.TOO_MANY_REQUESTS);
            }
        }
...
//# sourceMappingURL=UserRateLimitGuard.guard.js.map