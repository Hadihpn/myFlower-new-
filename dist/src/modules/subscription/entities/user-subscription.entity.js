...
__decorate([
    (0, typeorm_1.Column)({ name: 'tier_id' }),
    __metadata("design:type", Number)
], UserSubscription.prototype, "tierId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: subscription_status_enum_1.SubscriptionStatus,
        default: subscription_status_enum_1.SubscriptionStatus.PENDING,
    }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => subscription_tier_entity_1.SubscriptionTier, (tier) => tier.subscriptions),
    (0, typeorm_1.JoinColumn)({ name: 'tier_id' }),
    __metadata("design:type", subscription_tier_entity_1.SubscriptionTier)
], UserSubscription.prototype, "tier", void 0);
