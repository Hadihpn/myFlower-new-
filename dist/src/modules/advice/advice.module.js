...
exports.AdviceModule = AdviceModule = __decorate([
    (0, common_1.Module)({
        imports: [sensor_readings_module_1.SensorReadingsModule, user_plant_selections_module_1.UserPlantSelectionsModule, user_actions_module_1.UserActionsModule],
        controllers: [advice_controller_1.AdviceController],
        providers: [advice_service_1.AdviceService],
        exports: [advice_service_1.AdviceService],
    })
], AdviceModule);
